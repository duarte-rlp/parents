    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_pay', otree.db.models.StringField(max_length=10000, null=True)),
                ('pago_minimo', otree.db.models.IntegerField(default=10000, null=True)),
                ('pago_base', otree.db.models.IntegerField(default=20000, null=True)),
                ('is_menor_pago', otree.db.models.IntegerField(default=0, null=True)),
                ('pago_calculo', otree.db.models.IntegerField(null=True)),
                ('pago_real', otree.db.models.IntegerField(null=True)),
                ('data_html', otree.db.models.StringField(max_length=10000, null=True)),
