...
class Player(BasePlayer):
    p1 = models.IntegerField(label='2 x 10')
    p2 = models.IntegerField(label='3 x 20')
    p3 = models.IntegerField(label='6 x 19')
    p4 = models.IntegerField(label='20 - 9')
    p5 = models.IntegerField(label='60 - 19')
    p6 = models.IntegerField(label='18 - 20')
    p7 = models.IntegerField(label='10% de 100')
    p8 = models.IntegerField(label='10% de 800')
    p9 = models.IntegerField(label='20% de 200')
    p110 = models.IntegerField(label='9% de 200')
