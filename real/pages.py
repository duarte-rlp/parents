...
class graph_01(Page):
    ...
    def before_next_page(self):
        ...
        self.player.amount_cultivo_1 = int((Constants.cultivo_1[self.player.n_scene-1] * self.player.has_cultivo_1)/100) # calcula el $$$ por el cultivo A
        self.player.amount_cultivo_2 = int((Constants.cultivo_2[self.player.n_scene-1] * self.player.has_cultivo_2)/100) # calcula el $$$ por el cultivo B
